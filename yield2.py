...
# import sys
# to pass variables into the script from the command line, for the purposes of passing an address

def doTheThing (address): 
    api_key = open("alchemy_api_key_mainnet.txt", "r")
...
#else:
#    print("Oops. You need to pass a thingy when running the script")
...
finalPinataURL = doTheThing(address)
